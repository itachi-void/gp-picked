      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="xl:col-span-3 flex flex-col gap-6">
          ...
          <div className={`${
            ...
            {/* Volume Stats */}
            <div className={`grid grid-cols-2 gap-4 ${isGlass ? "bg-slate-50 dark:bg-white/[0.03] border border-slate-200/50 dark:border-white/[0.04]" : "bg-slate-50 dark:bg-black/40 border border-slate-100 dark:border-white/5"} p-4 rounded-2xl z-10`}>
              <div>
            ...
            <div className={`flex items-center justify-between ${isGlass ? "bg-slate-50 dark:bg-white/[0.03] border border-slate-200/50 dark:border-white/[0.04]" : "bg-slate-50 dark:bg-black/40 border border-slate-100 dark:border-white/5"} p-4 rounded-2xl z-10`}>
              <div className="flex items-center gap-3">
            ...
            <div className="grid grid-cols-2 gap-3.5 z-10">
              <div className={`p-3.5 ${isGlass ? "bg-slate-50 dark:bg-white/[0.03] border border-slate-200/50 dark:border-white/[0.04]" : "bg-slate-50 dark:bg-black/40 rounded-2xl border border-slate-100 dark:border-white/5"} flex flex-col justify-between h-[70px]`}>
