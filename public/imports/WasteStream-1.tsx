...
import { AreaChart as AreaIcon, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="w-full h-full flex flex-col gap-6 font-sans text-black dark:text-white transition-colors duration-300">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 pb-2 border-b border-border">
        ...
        {/* Chart Type Toggle */}
        <div className="inline-flex items-center bg-muted border border-border p-1 rounded-full shrink-0">
          <button
            onClick={() => setIsAreaChart(true)}
            aria-pressed={isAreaChart}
            className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-[11px] font-bold uppercase tracking-wider transition-all ${
              isAreaChart
