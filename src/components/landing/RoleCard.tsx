...
export function RoleCard({ role, index }: RoleCardProps) {
  ...
  return (
    <Reveal variant="up" delay={index * 0.15}>
      <div className="group bg-white rounded-2xl p-8 shadow-lg border-2 border-transparent cursor-pointer transition-all duration-300 hover:-translate-y-4 hover:scale-[1.03] hover:border-emerald-500 hover:shadow-[0_30px_60px_rgba(0,0,0,0.15)]">
