...
export function ImpactStatCard({ stat, index }: ImpactStatCardProps) {
  ...
  return (
    <Reveal variant="up" delay={index * 0.1} repeat margin="-100px">
      <div className="group bg-white/10 backdrop-blur-md rounded-2xl p-6 text-center cursor-pointer border border-white/20 transition-all duration-300 hover:-translate-y-2.5 hover:scale-105 hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)]">
