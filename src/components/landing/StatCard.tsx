...
export function StatCard({ stat, index }: StatCardProps) {
  ...
  return (
    <Reveal variant="scale-sm" delay={index * 0.1} repeat>
      <div className="group bg-white/90 backdrop-blur-lg rounded-2xl p-6 shadow-lg transition-all duration-300 cursor-pointer border border-transparent hover:border-emerald-200 hover:-translate-y-2.5 hover:shadow-[0_20px_40px_rgba(0,0,0,0.12)]">
